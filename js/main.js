...
function takeSnapshot() {
  ...
  getCanvasBlob(canvas).then(function (blob) {
    ...
    var myImage = document.getElementById('preview');
...
//  }, 
$.ajax({
  url:'https://api.bigdatacloud.net/data/reverse-geocode-client?latitude='+lat+'&longitude='+lan+'&localityLanguage=en',
